            ...
            public void onClick(View view) {
                if(index<=questions.length-1){
                    ...
                    if(index<=questions.length-1) {
                        ...
                        Toast.makeText(FlutterActivity.this, "Your score is: " +score+"/"+questions.length, Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    Toast.makeText(FlutterActivity.this, "Restart the app", Toast.LENGTH_SHORT).show();
                }
            }
        });
