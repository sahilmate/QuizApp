...
public class G_CloudActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gcloud);
            ...
            public void onClick(View view) {
                if(index<=questions.length-1){
                    ...
                    if(index<=questions.length-1) {
                        ...
                        Toast.makeText(G_CloudActivity.this, "Your score is: " +score+"/"+questions.length, Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    Toast.makeText(G_CloudActivity.this, "Restart the app", Toast.LENGTH_SHORT).show();
                }
            }
        });
